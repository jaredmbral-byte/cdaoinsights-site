...
export default async function DigestPreviewPage() {
  ...
  return (
    <main className="flex-1 max-w-[1200px] mx-auto px-6 pt-10 pb-24">
      <p className="font-mono text-xs uppercase tracking-[2px] text-[#6B6864] mb-4">Internal</p>
      <h1 className="text-2xl font-semibold text-[#0A0A0A] mb-4">Weekly Digest</h1>
      <p className="text-sm text-[#6B6864] mb-6">
        Preview the weekly digest at{' '}
        <a href="/api/digest/weekly" className="text-[#0A0A0A]">/api/digest/weekly</a>
